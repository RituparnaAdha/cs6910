...
Original file is located at
    https://colab.research.google.com/drive/12008clui4TvYL4eixygE55fgbe9E8e-Y
...
class RNN():
  def __init__(self):
    ...
    self.number_decoder_layer= 1config.get('num_decoder')
    self.hidden_layers =wandb.config.hidden_layer_size
    self.lr = 0.01
    self.beam_size= 1config.get('beam_size')
...
if __name__ == '__main__':
    ...
    sweep_id = wandb.sweep(sweep_config,entity="assignment3",project='a3_q5_sweep')
    wandb.agent(sweep_id, function=begin,entity="assignment3",project='a3_q5_sweep')
    wandb.finish()